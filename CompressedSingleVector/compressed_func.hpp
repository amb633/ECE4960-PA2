...
namespace compressed{
	...
	int decomposeMatrix( comp_r_mat* DS , comp_r_mat* LUS , comp_r_mat* AS );
	int matrixProduct ( comp_r_mat* result , comp_r_mat* A , comp_r_mat* vec);
	int jacobiSolver( comp_r_mat* X , comp_r_mat* DS , comp_r_mat* LUS , comp_r_mat* B );
